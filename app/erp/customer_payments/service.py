...
from app.erp.customer_payments.repository import CustomerPaymentRepository
...
from app.erp.customer_payments.workflow import assert_editable, next_status, transition_actions
        ...
        *,
        ...
        async with transaction(self.session):
            ...
            await self.outbox.enqueue(
                tenant_id,
                event_type="erp.customer_payment.posted",
    ...
    async def cancel(
        ...
        *,
        ...
        async with transaction(self.session):
            ...
            await self.outbox.enqueue(
                tenant_id,
                event_type="erp.customer_payment.cancelled",
                aggregate_type="customer_payment",
                aggregate_id=payment_id,
                payload={"customer_payment_id": str(payment_id)},
    ...
    async def allocate(
        ...
        *,
        ...
        async with transaction(self.session):
            ...
            await self.outbox.enqueue(
                tenant_id,
                event_type="erp.customer_payment.allocated",
                aggregate_type="customer_payment",
                aggregate_id=payment_id,
                payload={"customer_payment_id": str(payment_id)},
