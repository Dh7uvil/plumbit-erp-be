    ...
    async def create(
        ...
        async with transaction(self.session):
            ...
            number = await self.sequences.allocate(
                ...
                prefix=_SERIES,
                party_id=cast(UUID, values["supplier_id"]),
            )
        ...
        *,
        ...
        async with transaction(self.session):
            ...
            await self.outbox.enqueue(
                tenant_id,
                event_type="purchase.supplier_payment.posted",
    ...
    async def cancel(
        ...
        *,
        ...
        async with transaction(self.session):
            ...
            await self.outbox.enqueue(
                tenant_id,
                event_type="purchase.supplier_payment.cancelled",
                aggregate_type="supplier_payment",
                aggregate_id=payment_id,
                payload={"supplier_payment_id": str(payment_id)},
    ...
    async def allocate(
        ...
        *,
        ...
        async with transaction(self.session):
            ...
            await self.outbox.enqueue(
                tenant_id,
                event_type="purchase.supplier_payment.allocated",
                aggregate_type="supplier_payment",
                aggregate_id=payment_id,
                payload={"supplier_payment_id": str(payment_id)},
