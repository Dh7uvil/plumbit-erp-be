...
async def update_quotation(
    ...
    row = await service.update(
        tenant.tenant_id, quotation_id, payload, actor_user_id=tenant.user_id
    )
...
async def submit_quotation(
    ...
    row = await service.submit(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
...
async def approve_quotation(
    ...
    row = await service.approve(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
...
async def reject_quotation(
    ...
    row = await service.reject(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
...
async def reopen_quotation(
    ...
    row = await service.reopen(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
...
async def send_quotation(
    ...
    row = await service.send(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
...
async def accept_quotation(
    ...
    row = await service.accept(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
...
async def decline_quotation(
    ...
    row = await service.decline(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
...
async def cancel_quotation(
    ...
    row = await service.cancel(tenant.tenant_id, quotation_id, actor_user_id=tenant.user_id)
