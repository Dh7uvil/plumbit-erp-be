...
| `crm` | **Implemented:** customers, contacts, pipelines, lead_sources, lost_reasons, leads, opportunities, activities, notes, campaigns, reports (flat `/reports/sales-pipeline` and related CRM report paths gated by `reports.report.crm`). **Planned:** — |
